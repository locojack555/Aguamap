package cat.copernic.aguamap1.domain.repository.game
...
interface GameRepository {
     ...
     * @return Result con una [cat.copernic.aguamap1.domain.model.fountain.Fountain] al azar o null si no hay fuentes disponibles.
     */
